...
extern void jwzgles_glVertex2d (GLdouble x, GLdouble y);
...
extern void jwzgles_glBlendEquation(GLuint);
...
extern void jwzgles_glLoadMatrixd (const GLdouble *);


extern void jwzgles_glMultMatrixd (const GLdouble *);
